    ...
    <div class="page-form">
        <form  id="loginform"  method="post" class="form">
            <div class="header-content">
                <h1><spring:message code="sys.register.submit.label"/></h1>
            </div>
...
<!-- 	                </div> -->
	                <div class="pull-right">
	                    <button type="submit" class="btn btn-success"><spring:message code="sys.register.submit.label"/> &nbsp;
	                        <i class="fa fa-chevron-circle-right"></i>
	                    </button>
	                    <button type="reset" class="btn btn-success"><spring:message code="sys.register.reset.label"/> &nbsp;
	                        <i class="fa fa-chevron-circle-right"></i>
	                    </button>
	                </div>
	            </div>
